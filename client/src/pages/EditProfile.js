...
function EditProfile({ pState, checkUser }) {
  ...
  const profilePath =
    "http://192.168.43.199:5001/uploads/" || "http://localhost:5001/uploads/";
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      const config = {
        headers: {
          "Content-type": `${
            p_image ? "multipart/form-data" : "application/json"
          }`,
        },
      };
          ...
          <main>
            ...
            <div className="ep_content">
              ...
              <label className="inp inp_e">
                <input type="file" onChange={handleChange} name="p_image" />
                <span
                  style={{
                    fontSize: "20px",
                  }}
